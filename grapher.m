...
csvFiles = dir(fullfile(dataFolder, 'LC0_FZ_*_Round18_IA_2_filtered.csv'));
...
outCombinedPath = fullfile(dataFolder, 'LC0_All_FZ_Combined_Round18_IA-2.png');
...
for i = 1:numel(FZValues)
    ...
    outPath = fullfile(dataFolder, sprintf('LC0_FZ_%d_Plot_Round18_IA-2.png', FZVal));
